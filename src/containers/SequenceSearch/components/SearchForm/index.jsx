          ...
          <div className="col-sm-12">
            <div className="alert alert-info">
              <span style={{fontSize: fixCss}}>
                The infrastructure that hosts the sequence search tool is facing some issues. The issue is being worked on and should be resolved soon, apologies for any inconvenience.
              </span>
            </div>
          </div>
        </div>
